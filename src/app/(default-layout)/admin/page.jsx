...
function AdminDashboardPage() {
	return (
		<div data-transition-page data-animate="enter" className="gap-6 grid grid-cols-3 @max-lg/main:grid-cols-1 @max-3xl/main:grid-cols-2 mx-auto my-auto px-8 fade-in-up fade-out-up">
			...
			<TransitionLink href="/admin/desain-perusahaan/step-1-2" className="border-secondary border-2 w-full bg-base-100 shadow-sm transition-all hover:-translate-y-0.5 active:translate-y-0 cursor-pointer card">
